    ...
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Oil Paint 2",
                callback_data=select_style_callback.new(name="oil_painting_2"),
            ),
            InlineKeyboardButton(
                text="Watercolor >",
                callback_data=select_style_callback.new(name="watercolor_painting"),
            ),
        ],
...
select_style_2 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="Oil Paint",
                callback_data=select_style_callback.new(name="oil_painting"),
            ),
...
select_style_3 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Pencil >",
                callback_data=select_style_callback.new(name="pencil_sketch"),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ]
...
select_style_4 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Digital >",
                callback_data=select_style_callback.new(name="digital_art"),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ]
...
select_style_5 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Stained-glass >",
                callback_data=select_style_callback.new(name="stained-glass_window"),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ]
...
select_style_6 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Pollock >",
                callback_data=select_style_callback.new(name="pollock_number_23"),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ]
        ...
        [
            ...
            InlineKeyboardButton(
                ...
                callback_data=select_style_callback.new(
                    name="kahlo_self-portrait_with_necklace_of_thorns"
                ),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ...
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Escher >",
                callback_data=select_style_callback.new(
                    name="escher_hand_with_reflecting_sphere"
                ),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
...
select_style_9 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Picasso >",
                callback_data=select_style_callback.new(name="picasso_muse"),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ]
...
select_style_10 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Picabia >",
                callback_data=select_style_callback.new(name="picabia_udnie"),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ]
    ...
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Kandinsky >",
                callback_data=select_style_callback.new(
                    name="kandinsky_composition_vii"
                ),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
...
select_style_12 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Picasso 2 >",
                callback_data=select_style_callback.new(name="picasso_seated_nude"),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ]
...
select_style_13 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Picasso 3 >",
                callback_data=select_style_callback.new(name="picasso_self-portrait"),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ]
    ...
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Delaunay >",
                callback_data=select_style_callback.new(
                    name="delaunay_portrait_of_jean_metzinger"
                ),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
...
select_style_15 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Matisse >",
                callback_data=select_style_callback.new(name="matisse_woman_with_hat"),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ]
...
select_style_16 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Munch >",
                callback_data=select_style_callback.new(name="munch_scream"),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ]
...
select_style_17 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Van Gogh >",
                callback_data=select_style_callback.new(name="van_gogh_starry_night"),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ]
    ...
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Hokusai >",
                callback_data=select_style_callback.new(
                    name="hokusai_great_wave_off_kanagawa"
                ),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
...
select_style_19 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Turner >",
                callback_data=select_style_callback.new(name="turner_shipwreck"),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ]
...
select_style_20 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(
                text="Mosaic",
                callback_data=select_style_callback.new(name="roman_mosaic"),
            ),
        ],
        [InlineKeyboardButton(text="Select style", callback_data="accept_style")],
    ]
